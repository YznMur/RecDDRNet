...
_C.MODEL.USE_TEMPORAL_ATTENTION = False
_C.MODEL.ATTN_HEADS = 4
_C.MODEL.ATTN_HEAD_DIM = 32
_C.MODEL.KEYFRAME_INTERVAL = 5
_C.MODEL.USE_FEATURE_UPDATER = True
_C.MODEL.UPDATER_CHANNELS = 64
...
_C.LOSS.USE_CombinedLoss = False
...
_C.TRAIN.RANDOM_ROTATION = False
_C.TRAIN.ROTATION_MAX_DEGREE = 0

_C.TRAIN.RANDOM_BLUR = False
_C.TRAIN.RANDOM_CONTRAST = False

_C.TRAIN.RANDOM_CUTOUT = False
_C.TRAIN.CUTOUT_MAX_SIZE = 0

_C.TRAIN.POLY_POWER = False
_C.TRAIN.POLY_POWER = 0.9

_C.TRAIN.USE_POLY_LR = False
...
_C.TRAIN.SEQUENCE_MODE = False
_C.TRAIN.SEQUENCE_LEN = 4
