...
# CONFIG
# =========================
DDRNET_ROOT = "./RSM_v2_imagenet_2048_super_classes/cityscapes/ddrnet23_slim/test_result_rsmv2"  
DATASET_ROOT = "./data/cityscapes/overlays/test"
OUTPUT_DIR = "./videos_pytorch_rsmv2"
...
def create_side_by_side_video_from_folder(
    ...
    ddrnet_files = [f for f in os.listdir(ddrnet_root) if f.endswith("_leftImg8bit.jpg")]
    ...
    for fname in tqdm(ddrnet_files, desc=f"{split_name.upper()}"):
        ...
        overlay_base = fname.replace("_leftImg8bit.jpg", "_overlay.png")
        overlay_path = os.path.join(overlay_root, overlay_base)
